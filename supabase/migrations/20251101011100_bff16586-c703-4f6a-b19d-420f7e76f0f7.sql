-- 1) Garantir company_id em funis e preencher valores nulos
...
-- 2) Remover política genérica antiga de funis para substituir por políticas específicas
...
-- 4) Remover política genérica antiga de etapas para substituir por políticas específicas
